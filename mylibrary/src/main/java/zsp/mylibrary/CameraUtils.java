...
public class CameraUtils {
	public static final String CAMERA_IMAGE = "/sdcard/mmsq.jpg";

	public static final String CAMERA_VIDEO = "/sdcard/妈咪神器/mmsq.mp4";
	...
	public static void openCameraForImage(Activity activity) {
		...
		intent.putExtra(MediaStore.EXTRA_OUTPUT,
				Uri.fromFile(new File(StorageUtils
						.getOwnCacheDirectory(activity, "/妈咪神器/"), CAMERA_VIDEO)));
		activity.startActivityForResult(intent,
				RequestCode.FLAG_REQUEST_CAMERA_IMAGE);
	}
